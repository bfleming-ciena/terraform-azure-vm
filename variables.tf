...
variable "nb_data_disks" {
  description = "Specify the number of data disks"
  default     = "1"
}
...
variable "data_disk_size_gb_list" {
  description = "Storage data disk size size"
  default     = []
}

variable "data_disk_sa_type_list" {
  description = "Storage data disk size size"
  default     = []
}

variable "data_disk_spec" {
  type        = "list"
  description = "Storage data disk size size"
  default     = []
}
